...
- [x] #TODO the dark mode for the five sections: `Desktop1 - Desktop 5`
      --> That's why I named the folder portfolio_darkmode.
- [x] #TODO the toggle button with JS that can change the 2 images between 2 modes (light/dark) in the **Project section**
## Figma
